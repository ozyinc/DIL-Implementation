...
# Return the account ids and the count of events already attended
def already_attended_events_suggested(db: Database):
    return db.get_collection("students").aggregate([
        {
            '$project': {
                'account_id': 1,
                ...
                'already_attended_count': {
                    '$size': {
                        '$filter': {
                            ...
                            'cond': {
                                '$in': [
                                    '$$item.event', '$study_plan.suggested_events'
                                ]
                            }
                        }
                    }
...
def already_solved_exercises_suggested(db: Database):
    return db.get_collection("students").aggregate([
        {
            '$project': {
                'account_id': 1,
                ...
                'already_solved_count': {
                    '$size': {
                        '$filter': {
                            ...
                            'cond': {
                                '$in': [
                                    '$$item', '$study_plan.suggested_exercises'
                                ]
                            }
                        }
                    }
                                        ...
                                        '$and': [
                                            {
                                                ...
                                                '$eq': [
                                                    '$$attempt.type_', 'subjectEvaluation'
                                                ]
                                            }
                                        ]
                                    }
